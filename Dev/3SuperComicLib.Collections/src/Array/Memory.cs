...
{
    public readonly struct Memory<T> : IList<T>, IReadOnlyList<T>, IEquatable<Memory<T>>, IValueIterable<T>
    {
        internal readonly T[] _source;
        internal readonly int _start;
        public readonly int Length;

        internal Memory(T[] source, int startIndex, int length)
        {
            _source = source;
            _start = startIndex;
            Length = length;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IEnumerator<T> GetEnumerator() => new MemoryTEnumerator<T>(_source, _start, _start + Length);
        IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IValueIterator<T> Begin() => new MemoryTIterator<T>(_source, _start, _start + Length);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IValueIterator<T> RBegin() => new MemoryTReverseIterator<T>(_source, _start, _start + Length);
        #endregion
